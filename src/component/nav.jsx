...
const forumIcon = 
    ...
    <path transform="scale(.26458)" d="m131.52 543.68 37.629 0.0191c2.8554 1e-3 5.1543-2.3002 5.1543-5.1562v-34.689c0-2.856-2.2989-5.1543-5.1543-5.1543l-54.896-4e-4c-2.8554 1e-5 -5.1543 2.2983-5.1543 5.1543v34.689c0 2.856 2.2989 5.1562 5.1543 5.1562l10.17-0.0227 0.80357-3.0357-8.1763-1.5e-4c-2.5689-5e-5 -4.6367-1.9944-4.6367-4.4707v-30.076c0-2.4764 2.0678-4.4707 4.6367-4.4707h49.387c2.5689 0 4.6387 1.9943 4.6387 4.4707v30.076c0 2.4763-2.0698 4.4707-4.6387 4.4707-10.084 4e-5 -20.167 7e-5 -30.251 1.1e-4z" strokeWidth=".11364"/>
    <path d="m32.081 143.05h1.0512l-0.55515 2.2206 3.4549-2.2206 1.6596 1e-5 -6.7209 4.5593z" strokeWidth=".26458"/>
    </g>
    </g>
    </svg>;
...
const heartIcon = 
    ...
    <path transform="matrix(.26458 0 0 .26458 37.422 84.042)" d="m132.21 0c-135.08 0.17344-155.71 126.31-110.79 219.88 64.804 135 240.71 266.43 240.71 266.43s175.91-131.43 240.71-266.43c44.917-93.571 24.286-219.71-110.79-219.88-92.064-0.11822-129.92 104.88-129.92 104.88s-37.858-105-129.92-104.88z" fill="#ca3c44"/>
    </g>
    </g>
    <g transform="translate(-37.422 -200.81)" fill="#ff8080" strokeWidth=".02358">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul className=" nav navbar-nav ml-auto align-items-center-md">
                            ...
                            <li className="nav-item dropdown pl-1">
                                <button  id="dropdownbtn" className="nav-link dropdown-toggle px-4 shadow" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Username
                                </button>
                                <div className="dropdown-menu shadow" aria-labelledby="navbarDropdownMenuLink">
                                    <a className="dropdown-item" href="#">Settings</a>
                                    <a className="dropdown-item" href="#">Admintool</a>
