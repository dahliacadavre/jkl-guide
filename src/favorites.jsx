...
class Favorites extends React.Component {
    ...
    renderFavorite(){
        return(
            <div>
                ...
                <div className="card-body d-flex flex-wrap border-bottom">
    ...
    render() {
        return (
            ...
            > 
            { props =>
                <div style={props} id="favoritesWrapper" className="d-flex justify-content-around flex-wrap">
                    ...
                    <div className="col-lg-3 pl-lg-0 pr-xl-5 pr-lg-3">
                        <div id="favoriteContainer" className="container-fluid">
                            <div className="card h-100 shadow d-flex flex-column">
                                <div className="card-header">YOUR FAVORITES</div>
                                {
                                    this.renderFavorite()
                                }
                                {
