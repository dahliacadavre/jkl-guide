        ...
        return(
            <div id="regContainer" className="container-fluid p-0 m-0">
                <div className="colorLayer px-0 container-fluid d-flex flex-column align-items-center">
                    <h1 className="text-center pt-4">Register to JKL-Guide</h1>
                    <form className="col-md-8">
                        <div className="pt-5 pb-0 d-flex flex-wrap align-items-center">
                            <div className="form-group col-sm-6">
                                <label className="col-form-label-lg">Fullname</label>
                                <input className="form-control form-control-lg shadow" type="text" placeholder="firstname lastname"></input>
                            </div>
                            <div className="form-group col-sm-6">
                                <label className="col-form-label-lg">Username</label>
                                <input className="form-control form-control-lg shadow"  type="text" placeholder="username"></input>
                            </div>
                            <div className="form-group col-12">
                                <label className="col-form-label-lg">Email</label>
                                <input className="form-control form-control-lg shadow"  type="text" placeholder="user@email.com"></input>
                            </div>
                            <div className="form-group col-sm-6">
                                <label className="col-form-label-lg">Password</label>
                                <input className="form-control form-control-lg shadow"  type="password" placeholder="*******"></input>
                            </div>
                            <div className="form-group col-sm-6">
                                <label className="col-form-label-lg">Repeat Password</label>
                                <input className="form-control form-control-lg shadow"  type="password" placeholder="********"></input>
                            </div>
                            <div className="pt-sm-2 col-12 text-center">
                                <Link to="/">
                                <button type="button" className="register col-6 btn-lg shadow" 
                                onClick={
                                    console.log("log in")
                                }>Register</button>
                                </Link>
                    ...
                    <form className="text-center">
                        <div className="pt-5 pb-0 d-flex flex-column align-items-center">
                            ...
                            <div className="form-group">
                                <label className="col-form-label-lg m-0">Username</label>
                                <input className="form-control form-control-lg shadow" type="text" placeholder="username"></input>
                            </div>
                            <div className="form-group">
                                <label className="col-form-label-lg m-0">Password</label>
                                <input className="form-control form-control-lg shadow"  type="password" placeholder="********"></input>
                            </div>
                            <div className="col-12 px-0 pt-2">
                                <Link to="/JKL-Guide">
                                    <button id="login" className="login col-12 btn-lg shadow" 
                                    onClick={
                                        console.log("log in")
                                    }>Log in</button> 
                                </Link>
                            </div>
                            <h2 className="py-3 col-12">or</h2>
                            <div className="col-12 p-0">
                                <Link to="/Register">
                                    <button id="reg" className="register col-12 btn-lg shadow">Register</button>
                                </Link>
                            </div>
                        </div>
                    </form>
